...
// Source: hospital/internal/modules/domain/room/service (interfaces: IRoomRepo)
...
import (
	context "context"
	dto "hospital/internal/modules/domain/room/dto"
	reflect "reflect"
...
func (m *MockIRoomRepo) Delete(arg0 context.Context, arg1 int) error {
	m.ctrl.T.Helper()
...
func (m *MockIRoomRepo) GetByNum(arg0 context.Context, arg1 int) (*dto.Room, error) {
	m.ctrl.T.Helper()
...
func (m *MockIRoomRepo) Update(arg0 context.Context, arg1 int, arg2 *dto.UpdateRoom) (*dto.Room, error) {
	m.ctrl.T.Helper()
